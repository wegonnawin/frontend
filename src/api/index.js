...
export const queryTranslations = async (ids, locale)=>{
...
export const queryTopKWithTranslations = async (k=50, sLocale, tLocale)=>{
  ...
  .then(async (hits)=>{
    ...
    console.log('sentences', sentences, 'translations',translations)
...
export const queryTopK = (k, locale)=>{
